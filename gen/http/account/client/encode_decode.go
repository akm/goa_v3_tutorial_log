...
// set to call the "account" service "signin" endpoint
func (c *Client) BuildSigninRequest(ctx context.Context, v interface{}) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: SigninAccountPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("account", "signin", u.String(), err)
	}
	if ctx != nil {
...
// EncodeSigninRequest returns an encoder for requests sent to the account
// signin server.
func EncodeSigninRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*account.SigninPayload)
		if !ok {
			return goahttp.ErrInvalidType("account", "signin", "*account.SigninPayload", v)
		}
...
// DecodeSigninResponse returns a decoder for responses returned by the account
...
func DecodeSigninResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusOK:
			...
			if err != nil {
				return nil, goahttp.ErrDecodingError("account", "signin", err)
			}
			return body, nil
		...
		default:
			...
			return nil, goahttp.ErrInvalidResponse("account", "signin", resp.StatusCode, string(body))
		}
	}
}
